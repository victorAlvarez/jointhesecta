angular.module('mean.mensajes').controller('MensajesController', ['$scope', '$routeParams', '$location', 'Global', 'Mensajes', function ($scope, $routeParams, $location, Global, Mensajes) {
    $scope.global = Global;
